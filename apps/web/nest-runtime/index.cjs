/**
 * CJS Nest bootstrap for Vercel — packaged as @nexiora/nest-runtime so Next
 * leaves it external (serverExternalPackages) and does not webpack-break createRequire.
 * nest-dist is copied beside apps/web during scripts/vercel-web-build.js.
 */
'use strict';
